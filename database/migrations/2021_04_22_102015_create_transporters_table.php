...
class CreateTransportersTable extends Migration{
  public function up(){
    Schema::create('transporters', function (Blueprint $table) {
      ...
      $table->text('fromarea1')->nullable(true);
      $table->text('fromarea2')->nullable(true);
      $table->text('fromarea3')->nullable(true);
      $table->text('fromarea4')->nullable(true);
      $table->text('fromarea5')->nullable(true);
      $table->text('fromareastring1')->nullable(true);
      $table->text('fromareastring2')->nullable(true);
      $table->text('fromareastring3')->nullable(true);
      $table->text('fromareastring4')->nullable(true);
      $table->text('fromareastring5')->nullable(true);
      ...
      $table->text('toarea1')->nullable(true);
      $table->text('toarea2')->nullable(true);
      $table->text('toarea3')->nullable(true);
      $table->text('toarea4')->nullable(true);
      $table->text('toarea5')->nullable(true);
      $table->text('toareastring1')->nullable(true);
      $table->text('toareastring2')->nullable(true);
      $table->text('toareastring3')->nullable(true);
      $table->text('toareastring4')->nullable(true);
      $table->text('toareastring5')->nullable(true);
